...
int heroStrikeStrength = heroHP; // Selleks, et süsteem ei annaks veateadet
...
int villainStrikeStrength = heroHP; // Selleks, et süsteem ei annaks veateadet

Console.WriteLine($"Today {villain} ({villainHP} HP) with {villainWeapon} tries to take over the world!");

while(heroHP > 0 && villainHP > 0) // Mäng kestab kuni HP on väiksem kui 0
{
...
// Vatavalt nimes olevate tähtede arvule saavad tegelased HP-sid
